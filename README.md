...
```PowerShell
 java -cp .\target\rohitapp-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.bharadwaj.Consumer
```
...
```PowerShell
 java -cp .\target\rohitapp-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.bharadwaj.Producer
```
